...
# POO e Try-Catch
O projeto engloba os principais conceitos de Programação Orientada a Objetos (POO), como encapsulamento, herança, polimorfismo e uso de interfaces. As classes foram organizadas para separar as responsabilidades, facilitando a manutenção e a escalabilidade do código. Além disso, o sistema conta com tratamento de exceções usando blocos try-catch, garantindo que erros como entradas inválidas, falhas na leitura ou escrita de arquivos CSV, e problemas na manipulação da matriz sejam tratados de forma adequada, proporcionando uma experiência mais robusta e segura ao usuário. 
